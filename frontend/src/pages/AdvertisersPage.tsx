        ...
        {filtered.length === 0 ? (
          ...
          <>
            ...
            <div className="block md:hidden divide-y divide-slate-100">
              {filtered.map(adv => (
                <div key={adv.id} className="p-4 hover:bg-slate-50 transition space-y-2.5">
                  <div className="flex items-start justify-between gap-2">
                    <div className="min-w-0">
                      <div className="font-bold text-slate-900 text-sm truncate">{adv.name}</div>
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2 pt-1 border-t border-slate-100 text-xs">
                    ...
                    {isAdmin && adv.networkCode && (
                      <span className="px-2 py-0.5 rounded-md font-mono bg-slate-100 text-slate-700 text-[10px]">
                        {adv.networkCode}
                      </span>
                    )}
